...
0. Создать аккаунт Telegram. Не забывайте о правилах правильной регистрации, о которых говорилось в видео
1. Запускаем скрипт create_db.py и вносим данные. Тем самым мы создаем базу аккаунтов и добавляем в нее запись с ботом.
2. Запускаем скрипт create_clients.py тем самым генерируем файл-клиент для всех наших Telegram ботов
